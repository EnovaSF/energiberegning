    ...
    def calculate(self):
        ...
        for maaned in maaneder:
            setpunkttemp_for_kjoeling[maaned] = (
                                                ...
                                                varmetap_mot_grunnen_qg[
                                                    'jan']  # TODO: Er dette riktig? varmetap i jan for alle?
        ...
        Primaerenergi = Elektrisitet * self.Primaerenergi_faktor_el + Olje * self.Primaerenergi_faktor_olje + Gass * self.Primaerenergi_faktor_gass + Fjernvarme * self.Primaerenergi_faktor_fjernvarme + Biobrensel * self.Primaerenergi_faktor_bio + Annen_energivare * self.Primaerenergi_faktor_annet  # Energivare - Primærenergi behov [kWh/år]

        # Energivare - CO2-utslipp [kg/år]
        CO2_utslipp = Elektrisitet * self.CO2_faktor_el + Olje * self.CO2_faktor_olje + Gass * self.CO2_faktor_gass + Fjernvarme * self.CO2_faktor_fjernvarme + Biobrensel * self.CO2_faktor_bio + Annen_energivare * self.CO2_faktor_annet  # Energivare - CO2-utslipp [kg/år]

        # Energivare - Energi-kostnader [kr/år]
        Energi_kostnader = Elektrisitet * self.Energipris_el + Olje * self.Energipris_olje + Gass * self.Energipris_gass + Fjernvarme * self.Energipris_fjernvarme + Biobrensel * self.Energipris_bio + Annen_energivare * self.Energipris_annet  # Energivare - Energi-kostnader [kr/år]

        # Energivare - Energi-politisk vektet levert energi [kWh/år]
        Energi_politisk = Elektrisitet * self.Energipol_vektingsfaktor_el + Olje * self.Energipol_vektingsfaktor_olje + Gass * self.Energipol_vektingsfaktor_gass + Fjernvarme * self.Energipol_vektingsfaktor_fjernvarme + Biobrensel * self.Energipol_vektingsfaktor_bio + Annen_energivare * self.Energipol_vektingsfaktor_annet
