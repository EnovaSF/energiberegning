...
class EnergiBeregning:
    ...
    Forenklet beregningskjerne laget for Enova for energimerkesystemet

    Args:
        areal_oppv (float): Afl	m2	oppvarmet del av bruksareal (BRA), areal med temperatur på 15°C eller over	Romoppvarming	Oppv. bruksareal	Geometrisk	Byggmod. / brukerinntasting	 5 - 100000
        norm_varmekap (int): bygningens normaliserte varmekapasitet, enhet: Wh/(m2·K)
    """
    ...
    def calculate(self):
        ...
        for maaned in maaneder:
            Vifter += (
                spesifikk_i_driftstid * tid_drift_vent[maaned]
                + spesifikk_utenfor_driftstid * tid_drift_uvent[maaned]
            ) / 3600
        ...
        total_solfaktor_gjennomsnitt_vindu_tak = (
            areal_vindu_tak
            * self.solfaktor_vindu_tak
            * 0.9
        ...
        for maaned in maaneder:
            varmetilskudd[maaned] = (
                ...
                * (
                    ...
                    * areal_vindu_oest
                    * (
                        (1 - sol_tidsvariabel_ost_vest[maaned])
                        * self.solfaktor_vindu_oest
                        + sol_tidsvariabel_ost_vest[maaned]
                        * self.solfaktor_total_glass_skjerming_oest
                    )
                    * (1 - arealfraksjon_karm_oest)
                    ...
                    * (
                        (1 - sol_tidsvariabel_ost_vest[maaned])
                        * self.solfaktor_vindu_vest
                        + sol_tidsvariabel_ost_vest[maaned]
                        * self.solfaktor_total_glass_skjerming_vest
                    )
                    * (1 - arealfraksjon_karm_vest)
                ...
                + (
                    ...
                    * varmetilskudd_utstyr[maaned]
                        ...
                        * (
                            (
                                ...
                                * (
                                    ...
                                    else self.luftmengde_spesifikk_i_driftstid
                                )
                                * self.areal_oppv
                                + mean_tid_drift_ventilasjon
                                * (
                                    ventilasjonsvarmetapfaktor_bolig_vs_forretningsbygg
                                    if self.Forretningsbygg
                                    else self.luftmengde_spesifikk_utenfor_driftstid
                                )
                                * self.areal_oppv
                            )
                    ...
                    / 1000
                    * statistics.mean([tid_drift_gjsnitt, mean_timer_per_aar])
                )
                * self.areal_oppv
            )
        ...
        arealkorrekson = (
            ventilasjonsvarmetapfaktor_bolig_vs_forretningsbygg
            if self.Forretningsbygg
            else self.luftmengde_spesifikk_tilluft
        ...
        luftmengdekorreksjon_tilluft = (
            self.luftmengde_spesifikk_tilluft == 0
        ...
        luftmengdekorreksjon_avtrekk = (
            0 if self.luftmengde_spesifikk_avtrekksluft == 0 else arealkorrekson
        ...
        varmetap_mot_grunnen_ubv = (
                ...
                + (
                    (
                        ...
                        * (
                            ...
                            + self.varmekonduktivitet_grunn / self.U_gulvkonstruksjon
                        )
                    )
                    / (
                        self.tykkelse_grunnmur
            ...
            * math.log(
                self.oppfyllingshoyde_kjellervegg
                / (self.varmekonduktivitet_grunn / self.U_kjellerveggskonstruksjon)
                + 1
            )
        )
        ...
        varmetapskoeffisient_hpe_vegg_og_gulv = (
            0.37
            * self.omkrets_gulv
            * self.varmekonduktivitet_grunn
            * (
        ...
        # NS3031 - Varmetap mot grunnen, Qg (6.1.1.1.3) - Gulv mot grunn, Ug (Hvis B'>dt + 0,5*z)
        varmetap_mot_grunnen_qg_gulv_mot_grunn = self.varmekonduktivitet_grunn / (
            0.457 * self.areal_gulv_kjeller / (0.5 * self.omkrets_gulv)
            + self.tykkelse_grunnmur
            + self.varmekonduktivitet_grunn / self.U_gulvkonstruksjon
            + 0.5 * self.oppfyllingshoyde_kjellervegg
        )
        ...
        stasjonaer_varmetapskoeffisient_qg = (
            varmetapskoeffisient_ug
            if self.areal_gulv_kjeller / (0.5 * self.omkrets_gulv)
            > self.tykkelse_grunnmur
            + self.varmekonduktivitet_grunn / self.U_gulvkonstruksjon
            + 0.5 * self.oppfyllingshoyde_kjellervegg
            else varmetap_mot_grunnen_qg_gulv_mot_grunn
        ) * self.areal_gulv_kjeller + -(self.varmekonduktivitet_grunn / math.pi) * (
            math.log(
                self.kantisol_horisontal_dybde
                / (
                    self.tykkelse_grunnmur
            ...
            - math.log(
                ...
                / (
                    ...
                    + self.kantisol_tykkelse
                    * (
                        self.varmekonduktivitet_grunn / self.varmekonduktivitet_kantisol
                        - 1
                    )
                )
                + 1
        ...
        stasjonaer_varmetapskoeffisient_hg = (
            (
                varmetapskoeffisient_ug
                if self.areal_gulv_kjeller / (0.5 * self.omkrets_gulv)
                > self.tykkelse_grunnmur
        ...
        for maaned in maaneder:
            ...
            varmetap_mot_grunnen_qg[maaned] = tid[maaned] * (
                (
                    ...
                    else stasjonaer_varmetapskoeffisient_hg
                )
                * (self.aarsmiddeltemp_inne - self.aarsmiddeltemp_ute)
                + (
                    max([(varmetransportkoeffisient_qg), (varmetapskoeffisient_hpe)])
                    if self.faseforskjell_utetemp_varmetap == 2
                    else varmetapskoeffisient_hpe_vegg_og_gulv
                )
                * self.temp_amplitudevar
                * math.cos(
                    2
                    * math.pi
                    * (maaned_nummer[maaned] - 1 - self.faseforskjell_utetemp_varmetap)
                    / 12
                )
            )
        ...
        varmetapstall_hv = (
            ...
            * (
            ...
            / (ventilasjonsvarmetap_timer + mean_tid_drift_ventilasjon)
            * (1 - self.tempvirkningsgrad_varmegjenvinner)
        )  # (Varmetapstall) - Ventilasjonsvarmetap, HV
        ...
        varmetapstall_hinf = (
            ...
            * (self.lekkasjetall * self.terrengskjermingskoeff_e)
            / (
                ...
                * (
                    (
                        self.areal_oppv * luftmengdekorreksjon_tilluft
                        - self.areal_oppv * luftmengdekorreksjon_avtrekk
                    )
                    / (self.areal_oppv * self.etasjehoyde_innvendig * self.lekkasjetall)
                )
                ** 2
            )
            * self.areal_oppv
        ...
        for maaned in maaneder:
            maaned_ = (
                (
                    ...
                    + self.U_vindu_oest * areal_vindu_oest
                    + self.U_vindu_vest * areal_vindu_vest
                    + self.U_vindu_soer * areal_vindu_soer
                    + self.U_vindu_nord * areal_vindu_nord
                    + self.U_vindu_tak * areal_vindu_tak
                    + self.U_dor * self.areal_dor
                    + self.areal_oppv * self.kuldebro_normalisert
                    + self.varmetapsfaktor_uoppv
                    * (self.U_mot_uoppvarmet_sone * self.areal_mot_uoppvarmet)
                    + varmetapstall_hv
                    + varmetapstall_hinf
                )
        ...
        oppvarmingsbehov_tidskonstant = (
            ...
            + self.areal_oppv * self.kuldebro_normalisert
            + self.varmetapsfaktor_uoppv
            * (self.U_mot_uoppvarmet_sone * self.areal_mot_uoppvarmet + 0)
            + varmetapstall_hv
            + varmetapstall_hinf
            + (
                stasjonaer_varmetapskoeffisient_qg
        ...
        oppvarmingsbehov_tidskonstant = (
            1
            + self.norm_varmekap * self.areal_oppv / oppvarmingsbehov_tidskonstant / 16
        ...
        for maaned in maaneder:
            ...
            utnyttingsfaktor[maaned] = (
                ...
                if utnyttingfaktor_tmp < 0
                else oppvarmingsbehov_tidskonstant / (oppvarmingsbehov_tidskonstant + 1)
                if utnyttingfaktor_tmp == 1
                else (1 - utnyttingfaktor_tmp ** oppvarmingsbehov_tidskonstant)
                / (1 - utnyttingfaktor_tmp ** (oppvarmingsbehov_tidskonstant + 1))
            )
        ...
        for maaned in maaneder:
            oppvarmingsbehov[maaned] = (
                varmetap[maaned] - utnyttingsfaktor[maaned] * varmetilskudd[maaned]
            )
        ...
        for maaned in maaneder:
            energibehov_frostsikring_av_varmegjenvinner[maaned] = (
                0.33
                * (
                    ventilasjonsvarmetap_timer
                    * (
        ...
        for maaned in maaneder:
            setpunkttemp_for_kjoeling[maaned] = (
                ...
                * (self.U_mot_uoppvarmet_sone * self.areal_mot_uoppvarmet + 0)
                ...
                "jan"
            ]  # TODO: Er dette riktig? varmetap i jan for alle?
        ...
        for maaned in maaneder:
            utnytingsfaktor_tilskudd_v_varmetap[maaned] = (
                1 / (varmetilskudd[maaned] / setpunkttemp_for_kjoeling[maaned])
                if varmetilskudd[maaned] / setpunkttemp_for_kjoeling[maaned] < 0
                else (
                    oppvarmingsbehov_tidskonstant / (oppvarmingsbehov_tidskonstant + 1)
                    if varmetilskudd[maaned] / setpunkttemp_for_kjoeling[maaned] == 1
                    else (
                        1
                        - (varmetilskudd[maaned] / setpunkttemp_for_kjoeling[maaned])
                        ** oppvarmingsbehov_tidskonstant
                    )
                    / (
                        1
        ...
        varmetilskudd_mnd = {}
        for maaned in maaneder:
            varmetilskudd_mnd[maaned] = (
                0
                if varmetilskudd[maaned]
                - utnytingsfaktor_tilskudd_v_varmetap[maaned]
                * setpunkttemp_for_kjoeling[maaned]
                < 0
        ...
        energibehov_pumper_oppvarming_total_ep = (
            Romoppvarming
            / 8760
            * 1000
            / (
        ...
        energibehov_pumper_kjøling = (
            varmetilskudd_mnd_total / 8760 * 1000
        ...
        sirkulert_vannmengde_gjennom_pumpe = (
            energibehov_pumper_kjøling
            / (
        ...
        energibehov_pumper_kjoling_total = (
            sirkulert_vannmengde_gjennom_pumpe
        ...
        Pumper = (
            energibehov_pumper_oppvarming_total_ep + energibehov_pumper_kjoling_total
        )
        ...
        systemvirkningsgrad_levert_el = (
            (Romoppvarming + Ventilasjonsvarme)
        ...
        systemvirkningsgrad_levert_el_forbruk = (
            ...
            + self.energibehov_belysning * self.areal_oppv
            + self.energibehov_utstyr * self.areal_oppv
        ) * self.el_solcelle_andel_el_spesifikt_forbruk / self.systemvirkningsgrad_solcelle
        ...
        Elektrisitet = (
            ...
            + systemvirkningsgrad_levert_el_varmepumpe
            + systemvirkningsgrad_levert_el_kjoling
            + varmetilskudd_mnd_total / self.effektfaktor_kjoeleanlegg
        )
        ...
        # NS3031 (8.1) - Primærenergibehov; Levert energi for energivaren -  Levert elektrisitet (kWh)
        # NS3031 (8.1) - Primærenergibehov; Levert energi for energivaren -  Levert energi i form av olje (kWh)
        # NS3031 (8.1) - Primærenergibehov; Levert energi for energivaren -  Levert energi i form av gass (kWh)
        # NS3031 (8.1) - Primærenergibehov; Levert energi for energivaren -  Levert energi i form av fjernvarme (kWh)
        # NS3031 (8.1) - Primærenergibehov; Levert energi for energivaren -  Levert energi i form av biobrensel (kWh)
        # NS3031 (8.1) - Primærenergibehov; Levert energi for energivaren -  Levert energi i form av andre energivarer (kWh)
        ...
        # NS3031 (8.2) - CO2-utslipp; Levert energi for energivaren - Levert elektrisitet (kWh)
        # NS3031 (8.2) - CO2-utslipp; Levert energi for energivaren - Levert energi i form av olje (kWh)
        # NS3031 (8.2) - CO2-utslipp; Levert energi for energivaren - Levert energi i form av gass (kWh)
        # NS3031 (8.2) - CO2-utslipp; Levert energi for energivaren - Levert energi i form av fjernvarme (kWh)
        # NS3031 (8.2) - CO2-utslipp; Levert energi for energivaren - Levert energi i form av biobrensel (kWh)
        # NS3031 (8.2) - CO2-utslipp; Levert energi for energivaren - Levert energi i form av andre energivarer (kWh)
        ...
        # NS3031 (8.3) - Energikostnad; Levert energi for energivaren - Levert elektrisitet (kWh)
        # NS3031 (8.3) - Energikostnad; Levert energi for energivaren - Levert energi i form av olje (kWh)
        # NS3031 (8.3) - Energikostnad; Levert energi for energivaren - Levert energi i form av gass (kWh)
        # NS3031 (8.3) - Energikostnad; Levert energi for energivaren - Levert energi i form av fjernvarme (kWh)
        # NS3031 (8.3) - Energikostnad; Levert energi for energivaren - Levert energi i form av biobrensel (kWh)
        # NS3031 (8.3) - Energikostnad; Levert energi for energivaren - Levert energi i form av andre energivarer (kWh)
        ...
        # NS3031 (8.4) - Energikostnad; Levert energi for energivaren - Levert elektrisitet (kWh)
        # NS3031 (8.4) - Energikostnad; Levert energi for energivaren - Levert energi i form av olje (kWh)
        # NS3031 (8.4) - Energikostnad; Levert energi for energivaren - Levert energi i form av gass (kWh)
        # NS3031 (8.4) - Energikostnad; Levert energi for energivaren - Levert energi i form av fjernvarme (kWh)
        # NS3031 (8.4) - Energikostnad; Levert energi for energivaren - Levert energi i form av biobrensel (kWh)
        # NS3031 (8.4) - Energikostnad; Levert energi for energivaren - Levert energi i form av andre energivarer (kWh)
        ...
        Primaerenergi = (
            Elektrisitet * self.Primaerenergi_faktor_el
            + Olje * self.Primaerenergi_faktor_olje
            + Gass * self.Primaerenergi_faktor_gass
            + Fjernvarme * self.Primaerenergi_faktor_fjernvarme
            + Biobrensel * self.Primaerenergi_faktor_bio
            + Annen_energivare * self.Primaerenergi_faktor_annet
        )  # Energivare - Primærenergi behov [kWh/år]

        # Energivare - CO2-utslipp [kg/år]
        CO2_utslipp = (
            Elektrisitet * self.CO2_faktor_el
            + Olje * self.CO2_faktor_olje
            + Gass * self.CO2_faktor_gass
            + Fjernvarme * self.CO2_faktor_fjernvarme
            + Biobrensel * self.CO2_faktor_bio
            + Annen_energivare * self.CO2_faktor_annet
        )  # Energivare - CO2-utslipp [kg/år]

        # Energivare - Energi-kostnader [kr/år]
        Energi_kostnader = (
            Elektrisitet * self.Energipris_el
            + Olje * self.Energipris_olje
            + Gass * self.Energipris_gass
            + Fjernvarme * self.Energipris_fjernvarme
            + Biobrensel * self.Energipris_bio
            + Annen_energivare * self.Energipris_annet
        )  # Energivare - Energi-kostnader [kr/år]

        # Energivare - Energi-politisk vektet levert energi [kWh/år]
        Energi_politisk = (
            Elektrisitet * self.Energipol_vektingsfaktor_el
            + Olje * self.Energipol_vektingsfaktor_olje
            + Gass * self.Energipol_vektingsfaktor_gass
            + Fjernvarme * self.Energipol_vektingsfaktor_fjernvarme
            + Biobrensel * self.Energipol_vektingsfaktor_bio
            + Annen_energivare * self.Energipol_vektingsfaktor_annet
        )
