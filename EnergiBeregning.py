...
class EnergiBeregning:
    ...
    def calculate(self) -> Output:
        ...
        varmetap_mot_grunn_tykkelse_kjellervegg_dw = self.__divide_or_zero(
        ...
        karakteristisk_dimensjon_gulv_b = self.__divide_or_zero(
            self.areal_gulv_kjeller, (0.5 * self.omkrets_gulv)
        )

        # NS3031 - Varmetap mot grunnen, Qg (6.1.1.1.3) - Vegg mot grunn, Ubw
        varmetap_vegg_mot_grunn_ubw = (
            self.__divide_or_zero(
                (2 * (self.varmekonduktivitet_grunn)),
        ...
        levert_el_til_varmesystemer = self.__divide_or_zero(
        ...
        levert_el_varmepumpesystemer = self.__divide_or_zero(
            (Romoppvarming + Ventilasjonsvarme)
        ...
        levert_elektrisitet_termisk_solenergi = self.__divide_or_zero(
            (Romoppvarming + Ventilasjonsvarme)
        ...
        levert_el_kjolseystemer = self.__divide_or_zero(
            energibehov_kjoling_total, self.effektfaktor_kjoeleanlegg
        )
        ...
        levert_el_spesifikt_forbruk = netto_el_spesifikt_forbruk * (
            ...
            netto_el_spesifikt_forbruk * (self.el_solcelle_andel_el_spesifikt_forbruk),
        ...
        fjernvarme = self.__divide_or_zero(
            (Romoppvarming + Ventilasjonsvarme)
        ...
        Biobrensel = self.__divide_or_zero(
            (Romoppvarming + Ventilasjonsvarme)
        ...
        Annen_energivare = self.__divide_or_zero(
            (Romoppvarming + Ventilasjonsvarme)
