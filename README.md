...
Her ligger beregningskjernen for energimerkeordningen for bygg som brukes av Enova for energimerking av boliger. 
...
## Kjøring
### Docker
Enkleste måten å kjøre koden på er med [Docker](https://docker.com):
```shell
docker pull ghcr.io/enovasf/energiberegning:main
docker run -p 7071:80 -it ghcr.io/enovasf/energiberegning:main
```

Denne kommandoen vil kjøre opp en azure function lokalt på port 7071 som kan gjøre energiberegninger via HTTP POST feks (referansebergning tek07 småhus): 
```shell 
curl -X POST --location "http://localhost:7071/api/EnergyCalculation" \
...
```json
{
  "romoppvarming": 11809.982403138307,
  "ventilasjonsvarme": 235.7062500427955,
  "varmtvann": 6000,
  "vifter": 1460,
  "pumper": 43.254151421121136,
  "belysning": 3400,
  "teknisk_utstyr": 4600,
  "kjoeling": 0,
  "totalt_netto_energibehov": 27548.942804602226,
  "elektrisitet": 15964.999883505185,
  "olje": 11237.503797221823,
  "gass": 2387.298027227534,
  "fjernvarme": 4198.733907814936,
  "biobrensel": 0,
  "annen_energivare": 0,
  "totalt_levert_energi": 33788.53561576948,
  "primaerenergi": 47613.27265330536,
  "co2_utslipp": 9988.554864328298,
  "energi_kostnader": 26985.530494022656,
  "energi_politisk": 43526.413594640435
}
```
...
Ønsker man å kjøre egne beregninger i Python kan EnergiBeregning.py inkluderes i annen kode. 

## Test
For å kjøre alle [referanseberegingene](reference_calculations): 

```shell
python -m test_EnergiBeregning
```
