...
"""
Sydvendte vinduer, lett bygg
Denver-klima
"""
ashrae_besttest_600 = calc.EnergiBeregning(
    areal_oppv=48,
    norm_varmekap=38,
...
ashrae_besttest_600_expected_output = calc.Output(
    Romoppvarming=7_483,  # TODO should be 7482, rounding error?
    Ventilasjonsvarme=0,
    Varmtvann=0,
    Vifter=0,
    Belysning=0,
    ...
    Teknisk_utstyr=0,
    Kjoeling=0,
    Totalt_netto_energibehov=7_483,  # TODO should be 7482, rounding error?
    Elektrisitet=7_635,
    Olje=0,
    Gass=0,
    Fjernvarme=0,
