...
"""
Ø/V-vendte vinduer, overheng og finner, lett bygg
Denver-klima
"""
ashrae_besttest_630 = calc.EnergiBeregning(
    areal_oppv=48,
    norm_varmekap=38,
...
ashrae_besttest_630_expected_output = calc.Output(
    Romoppvarming=7507,
    Ventilasjonsvarme=0,
    Varmtvann=0,
    Vifter=0,
    ...
    Teknisk_utstyr=0,
    Kjoeling=0,
    Totalt_netto_energibehov=7507,
    Elektrisitet=7661,  # TODO AssertionError: 7660 != 7661
    Olje=0,
    Gass=0,
    Fjernvarme=0,
    Biobrensel=0,
    Annen_energivare=0,
    Totalt_levert_energi=7661,  # TODO AssertionError: 5860 != 5862
