...
"""
Ø/V-vendte vinduer, nattventilasjon, lett bygg
Denver-klima
"""
ashrae_besttest_650 = calc.EnergiBeregning(
    areal_oppv=48,
    norm_varmekap=38,
...
ashrae_besttest_650_expected_output = calc.Output(
    ...
    CO2_utslipp=401,
    Energi_kostnader=5633,  # TODO AssertionError: 5632 != 5633
