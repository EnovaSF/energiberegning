...
"""
Sydvendte vinduer, nattsenket temperatur, tungt bygg
Denver-klima
"""
ashrae_besttest_950 = calc.EnergiBeregning(
    areal_oppv=48,
    norm_varmekap=89,
    kuldebro_normalisert=0,
    temp_settpunkt_oppvarming=20,
    temp_settpunkt_oppvarming_natt=10,
    areal_tak=48,
    ...
    luftmengde_spesifikk_utenfor_driftstid=29.2,
...
ashrae_besttest_950_expected_output = calc.Output(
    romoppvarming=5744,  # TODO AssertionError: 5742 != 5744
    ventilasjonsvarme=0,
    varmtvann=0,
    vifter=0,
    belysning=0,
    ...
    teknisk_utstyr=0,
    kjoeling=0,
    totalt_netto_energibehov=5744,  # TODO AssertionError: 5742 != 5744
    elektrisitet=5862,  # TODO AssertionError: 5860 != 5862
    olje=0,
    gass=0,
    fjernvarme=0,
    biobrensel=0,
    annen_energivare=0,
    totalt_levert_energi=5862,  # TODO AssertionError: 5860 != 5862
    primaerenergi=8792,  # TODO AssertionError: 8789 != 8792
    co2_utslipp=334,
    energi_kostnader=4689,  # TODO AssertionError: 4688 != 4689
    energi_politisk=7034,  # TODO AssertionError: 7031 != 7034
)
