...
divide_by_zero = calc.EnergiBeregning(
    areal_oppv=200.0,
    norm_varmekap=64,
    ...
    temp_differanse_veskekrets_kjoling=0,
    ...
    systemvirkningsgrad_solcelle=0,
    systemvirkningsgrad_elektrisk_oppv_ventilasjon=0.92,
    systemvirkningsgrad_elektrisk_tappevann_varme=0,
    systemvirkningsgrad_varmepumpeanlegg_oppv_ventilasjon=0,
    systemvirkningsgrad_varmepumpeanlegg_tappevann_varme=0,
    systemvirkningsgrad_solfanger_termisk_oppv_ventilasjon=0,
    systemvirkningsgrad_solfanger_termisk_tappevann_varme=0,
    effektfaktor_kjoeleanlegg=0,
    olje_andel_energi_oppv_ventilasjon=0.30,
    olje_andel_energi_tappevann_varme=0.50,
    systemvirkningsgrad_olje_oppv_ventilasjon=0,
    systemvirkningsgrad_olje_tappevann_varme=0,
    gass_andel_energi_oppv_ventilasjon=0.10,
    gass_andel_energi_tappevann_varme=0.10,
    systemvirkningsgrad_gass_oppv_ventilasjon=0,
    ...
    systemvirkningsgrad_fjernvarme_oppv_ventilasjon=0,
    systemvirkningsgrad_fjernvarme_tappevann=0,
    bio_andel_energi_oppv_ventilasjon=0.00,
    bio_andel_energi_tappevann_varme=0.00,
    systemvirkningsgrad_bio_oppv_ventilasjon=0,
    systemvirkningsgrad_bio_tappevann=0,
    annet_andel_energi_oppv_ventilasjon=0.00,
    annet_andel_energi_tappevann_varme=0.00,
    systemvirkningsgrad_annet_oppv_ventilasjon=0,
    systemvirkningsgrad_annet_tappevann=0,
    CO2_faktor_el=0.357,
...
divide_by_zero_expected_output = calc.Output(
    romoppvarming=11810,
    ...
    teknisk_utstyr=4600,
    kjoeling=0,
    totalt_netto_energibehov=27549,
    elektrisitet=14741,
    olje=0,
    gass=714,
    fjernvarme=0,
