...
tek_07_barnehage = calc.EnergiBeregning(
    ...
    areal_tak=100.00,
    areal_vegg_oest=42.50,
    areal_vegg_vest=42.50,
    areal_vegg_soer=42.50,
    areal_vegg_nord=42.50,
    areal_gulv_mot_det_fri=0.00,
    areal_vindu_oest=9.50,
    areal_vindu_vest=9.50,
    areal_vindu_soer=9.50,
    areal_vindu_nord=9.50,
    ...
    luftmengde_spesifikk_i_driftstid=8.00,
    luftmengde_spesifikk_utenfor_driftstid=2.00,
    terrengskjermingskoeff_e=0.07,
    terrengskjermingskoeff_f=15.00,
    lekkasjetall=2.50,
    etasjehoyde_innvendig=2.60,
    luftmengde_spesifikk_tilluft=8.00,
    luftmengde_spesifikk_avtrekksluft=8.00,
    ...
    varmetilskudd_utstyr_jan=2.00,
    varmetilskudd_utstyr_feb=2.00,
    varmetilskudd_utstyr_mar=2.00,
    varmetilskudd_utstyr_apr=2.00,
    varmetilskudd_utstyr_mai=2.00,
    varmetilskudd_utstyr_jun=2.00,
    varmetilskudd_utstyr_jul=2.00,
    varmetilskudd_utstyr_aug=2.00,
    varmetilskudd_utstyr_sep=2.00,
    varmetilskudd_utstyr_okt=2.00,
    varmetilskudd_utstyr_nov=2.00,
    varmetilskudd_utstyr_des=2.00,
    varmetilskudd_person_jan=6.00,
    varmetilskudd_person_feb=6.00,
    varmetilskudd_person_mar=6.00,
    varmetilskudd_person_apr=6.00,
    varmetilskudd_person_mai=6.00,
    varmetilskudd_person_jun=6.00,
    varmetilskudd_person_jul=6.00,
    varmetilskudd_person_aug=6.00,
    varmetilskudd_person_sep=6.00,
    varmetilskudd_person_okt=6.00,
    varmetilskudd_person_nov=6.00,
    varmetilskudd_person_des=6.00,
    energibehov_tappevann=10.00,
    energibehov_belysning=21.00,
    energibehov_utstyr=5.00,
    ...
    tid_drift_oppv_belysn_utstyr_jan=310,
    tid_drift_oppv_belysn_utstyr_feb=280,
    tid_drift_oppv_belysn_utstyr_mar=310,
    tid_drift_oppv_belysn_utstyr_apr=300,
    tid_drift_oppv_belysn_utstyr_mai=310,
    tid_drift_oppv_belysn_utstyr_jun=300,
    tid_drift_oppv_belysn_utstyr_jul=310,
    tid_drift_oppv_belysn_utstyr_aug=310,
    tid_drift_oppv_belysn_utstyr_sep=300,
    tid_drift_oppv_belysn_utstyr_okt=310,
    tid_drift_oppv_belysn_utstyr_nov=300,
    tid_drift_oppv_belysn_utstyr_des=310,
    tid_drift_vent_jan=310,
    tid_drift_vent_feb=280,
    tid_drift_vent_mar=310,
    tid_drift_vent_apr=300,
    tid_drift_vent_mai=310,
    tid_drift_vent_jun=300,
    tid_drift_vent_jul=310,
    tid_drift_vent_aug=310,
    tid_drift_vent_sep=300,
    tid_drift_vent_okt=310,
    tid_drift_vent_nov=300,
    tid_drift_vent_des=310,
    tid_drift_person_jan=310,
    tid_drift_person_feb=280,
    tid_drift_person_mar=310,
    tid_drift_person_apr=300,
    tid_drift_person_mai=310,
    tid_drift_person_jun=300,
    tid_drift_person_jul=310,
    tid_drift_person_aug=310,
    tid_drift_person_sep=300,
    tid_drift_person_okt=310,
    tid_drift_person_nov=300,
    tid_drift_person_des=310,
    utetemp_jan=-3.7,
    utetemp_feb=-4.8,
    utetemp_mar=-0.5,
    utetemp_apr=4.8,
...
tek_07_barnehage_expected_output = calc.Output(
    romoppvarming=10_952,
    ventilasjonsvarme=0,
    varmtvann=2_000,
    vifter=5_475,
    belysning=4_200,
    pumper=40,
    teknisk_utstyr=1_000,
    kjoeling=0,
    totalt_netto_energibehov=23_667,
    elektrisitet=15_593,
    olje=5_566,
    gass=1_599,
    fjernvarme=2_944,
