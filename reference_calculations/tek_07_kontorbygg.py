...
tek_07_kontorbygg_expected_output = calc.Output(
    Romoppvarming=167_209,
    Ventilasjonsvarme=0,
    Varmtvann=75_000,
    Vifter=419_750,
    Belysning=375_000,
    Pumper=13_533,
    Teknisk_utstyr=510_000,
    Kjoeling=1_111_732,
    Totalt_netto_energibehov=2_672_224,
    Elektrisitet=1_865_059,
    Olje=113_848,
    Gass=29_902,
    Fjernvarme=55_047,
    Biobrensel=0,
    Annen_energivare=0,
    Totalt_levert_energi=2_063_857,
    Primaerenergi=3_060_759,
    CO2_utslipp=712_635,
    Energi_kostnader=1_647_213,
    Energi_politisk=2_505_515,
)
