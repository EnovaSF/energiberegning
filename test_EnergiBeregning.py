...
class TestCalculation(unittest.TestCase):
    ...
    def test_ventilasjonsvarme(self):
        self.assertEqual(
            236, round(calc_result.Ventilasjonsvarme)
        )  # add assertion here
    ...
    def test_totalt_netto_energibehov(self):
        self.assertEqual(
            27549, round(calc_result.Totalt_netto_energibehov)
        )  # add assertion here
    ...
    def test_totalt_levert_energi(self):
        self.assertEqual(
            33789, round(calc_result.Totalt_levert_energi)
        )  # add assertion here
    ...
    def test_energi_kostnader(self):
        self.assertEqual(
            26986, round(calc_result.Energi_kostnader)
        )  # add assertion here

    def test_energi_politisk(self):
        self.assertEqual(
            43526, round(calc_result.Energi_politisk)
        )  # add assertion here
